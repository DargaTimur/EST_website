...
export const countries = [
  ...
  { value: 'gre', label: 'Greece' },
  { value: 'hun', label: 'Hungary' },
  { value: 'ice', label: 'Iceland' },
  { value: 'ind', label: 'India' },
  { value: 'ins', label: 'Indonesia' },
  { value: 'ire', label: 'Ireland' },
  { value: 'isr', label: 'Israel' },
  { value: 'ita', label: 'Italy' },
  { value: 'jp', label: 'Japan' },
  { value: 'kaz', label: 'Kazakstan' },
  { value: 'kuw', label: 'Kuwait' },
  { value: 'lat', label: 'Latvia' },
  { value: 'lie', label: 'Liechtenstein' },
  { value: 'lit', label: 'Lithuania' },
  { value: 'lux', label: 'Lusembourg' },
  { value: 'mal', label: 'Malaysia' },
  { value: 'mex', label: 'Mexico' },
  { value: 'mon', label: 'Mongolia' },
  { value: 'mor', label: 'Morocco' },
  { value: 'net', label: 'Netherlands' },
  { value: 'new', label: 'New Zealand' },
  ...
  { value: 'slo', label: 'Slovakia' },
  { value: 'slv', label: 'Slovenia' },
  { value: 'sko', label: 'South Korea' },
  { value: 'spa', label: 'Spain' },
  { value: 'swe', label: 'Sweden' },
  { value: 'swi', label: 'Switzerland' },
  { value: 'twa', label: 'Taiwan' },
  ...
  { value: 'vie', label: 'Vietnam' },
  { value: 'yem', label: 'Yemen' },
  { value: 'zam', label: 'Zambia' },
  { value: 'zim', label: 'Zimbabwe' },
]

export const booking = [
  { value: 'city', label: 'City tour'},
  { value: 'gobi', label: 'Gobi tour'},
  { value: 'central', label: 'Central tour'},
  { value: 'khuvsgul1', label: 'Khuvsgul Lake tour (short)'},
  { value: 'khuvsgul2', label: 'khuvsgul Lake tour'},
  { value: 'gobikhangai', label: 'Gobi-Khangai tour'},
]
