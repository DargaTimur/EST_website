...
const Reindeer = async ({params: {locale}}: {params: {locale: string}}) => {
      ...
      <div className='visibility_area'> {/*For description*/}
        <div>
          ...
          <div style={{ padding: "2%", backgroundColor: "#f6f5ff"}}>
            <h2 className='tour_left_column_header'>{t('reindeer_tour_title')}</h2>
            <p className='tour_individual_text'>{t('reindeer_tour_text')}</p>
